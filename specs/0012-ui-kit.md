...
- **A full component library.** Buttons, cards, and inputs are themed in
  [0008](0008-design-system.md); wrapping them adds a layer with no payoff.
...
`app_banners.dart` holds `OfflineBanner` ([0011](0011-connectivity.md)) and
`EnvironmentBanner` ([0009](0009-environments.md)), both attached in
