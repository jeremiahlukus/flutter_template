...
import '../../../counter/counter_page.dart' as _i4;
...
class AppRouter extends _i5.RootStackRouter {
  ...
  final Map<String, _i5.PageFactory> pagesMap = {
    ...
    CounterRoute.name: (routeData) {
      return _i5.MaterialPageX<dynamic>(routeData: routeData, child: const _i4.CounterPage());
    }
  };
  ...
  List<_i5.RouteConfig> get routes => [
        ...
        _i5.RouteConfig(CounterRoute.name, path: '/counter')
      ];
}
