...
| 0006-R9 | `test_rules/storage.rules.test.js` (whole file) → [spec 0016](0016-emulator-and-rules.md) |

## Open questions

- ~~R9 is unverified.~~ **Resolved by [0016](0016-emulator-and-rules.md):** both
...
- Image *picking* is covered ([0019](0019-media.md)), but nothing yet uses
